...
export default function Header() {
  ...
  return (
    <>
    <header className="bg-white shadow-sm fixed w-full z-20 top-0 left-0">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover className="relative hidden lg:flex lg:flex-1 lg:justify-end">
            <Popover.Button className="outline-gray-400 rounded-full outline outline-offset-2 outline-1 flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
            <Bars3Icon className="h-6 w-6" aria-hidden="true" />
            ...
            >
               ...
               {/* <div
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <UserIcon className="h-6 w-6 text-gray-600 group-hover:text-gray-600" aria-hidden="true" />
                      </div>
                      <div className="flex-auto">
                        <a href="{item.href}" className="block font-semibold text-gray-900">
                          Login
    ...
    {showModal ? (
        <>
          ...
          <center>
          <a href="#" className="items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img className="w-20 h-15 mr-2" src={Logo} alt="logo"/> 
          </a>
          </center>
